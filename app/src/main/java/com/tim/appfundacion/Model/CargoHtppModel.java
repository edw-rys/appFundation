...
public class CargoHtppModel implements OnHttpRequestComplete {
        ...
        if (status.isSuccess()){
            ...
            try {
                ...
                for (int i = 0;i < jsonArr.length(); i++){
                    ...
                    cargos.add(gson.fromJson(strNac, Cargo.class));
    ...
    public ArrayList<Cargo> getCargos(){
        ...
        client.excecute("http://192.168.1.9:81/backend_app_samoyed/cargo");
        return cargos;
    }
}
